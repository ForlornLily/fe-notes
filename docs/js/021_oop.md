...
![](../images/39b41ef85b1d220316b280f6e17948c3.png)
![](../images/917aade8456513fba30c042028208c5e.png)

- `[[Enumerable]]` 能否再 for-in 循环中出现
...
![](../images/af86abd5fc52a1fd222d0136bb7860bd.png)
...
super 初始化了 this。也就是使用 this 之前必须调用 super
